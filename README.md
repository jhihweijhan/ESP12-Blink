...
1. ESP 顯示 `MQTT --`（紅色）
先確認 broker 位址/帳密是否正確，再看 Sender 日誌。顯示 `MQTT ..`（黃色）表示正在重連中。
...
- [MQTT 規格 (metrics v2)](docs/protocol/metrics-v2.md)
- [韌體效能升級報告 (2026-03-24)](docs/2026-03-24-firmware-performance-upgrade.md)
- [MQTT 穩定性修復報告 (2026-02-22)](docs/2026-02-22-mqtt-stability-debug-report.md)
